...
//   let sentenceArr = inputP.textContent.split('.').map(str => str.replace(regex, ' ')).map(str => str.replace(emptySpaces, ' '));
...
//     } else {
//       tempSentence = sentenceArr[i] + '.' + sentenceArr[i + 1] + '.' + sentenceArr[i + 2] + '.';
//     }
